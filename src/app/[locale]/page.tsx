  ...
  return (
    <>
      ...
      <section className="flex items-center justify-center border-y border-y-bgBtn dark:border-y-darkModeBorder">
        <div className="flex flex-col 480px:flex-row gap-10 480px:gap-6 items-center 480px:justify-between  text-center px-6 py-16 font-bold text-customGray dark:text-bgDark">
